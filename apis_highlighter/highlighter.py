...
def highlight_textTEI(*args, **kwargs):
    ...
    for an in lst_annot:
        ...
        try:
            ...
            # EL NEW:
            lst_classes = str(an[0].entity_link_new.relation_type.pk)
            ...
            try:
                ...
                # EL NEW:
                lst_classes = str(an[0].entity_link_new.kind.pk)
        ...
        if len(an) > 1:
            ...
            try:
                ...
                # EL NEW:
                entity_type = type(an[0].entity_link_new).__name__
                entity_pk = an[0].entity_link_new.pk
            ...
            try:
                ...
                # EL NEW:
                entity_uri = an[0].entity_link_new.uri_set.values_list('uri', flat=True)[0]
                ...
                # EL NEW:
                entity_uri = 'internal db id: {}'.format(an[0].entity_link_new.pk)
